...
pdf("./plt/01_partialeffects_int.pdf", width = 11, height = 8, paper="a4r")
...
pdf("./plt/01_partialeffects_cont.pdf", width = 11, height = 8, paper="a4r")
...
dplyr::filter(fe, group == "lithology") |>
  ...
  theme_plot(),
ncol = 2)
ggsave("./plt/01_partialeffects_cat.pdf", width = 7, height = 8, dpi = 300, units = "in", device='pdf')
...
ggsave("./plt/02_varimportance.pdf", width = 7, height = 8, dpi = 300, units = "in", device='pdf')
